...
func (r CCSReporter) printValuesInCSVFormatPersTime(prjTime ProjectReportSetting) {
	...
	r.printValuesInCSVFormatSFF("LCC eServices Region South-East", teamMembers+","+productOwner, prjTime.GetProject(), timeEntry.ToFloat64InHours(), timeEntry.GetInPercent())
}
